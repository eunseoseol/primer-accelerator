    ...
    <main className="min-h-screen bg-zinc-950 text-white selection:bg-white/20">
      ...
      <section id="portfolio" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {[
            { n: "ODK Media", d: "아시아 영상 퍼블리싱" },
            { n: "StyleShare", d: "패션 SNS 기반 커머스 (무신사 매각)" },
            { n: "MyRealTrip", d: "현지 여행 마켓" },
            { n: "Bungaejangter", d: "중고거래 (네이버)" },
            { n: "Dailyhotel", d: "호텔 예약 (야놀자)" },
            { n: "Soomgo", d: "전문가 매칭" },
            { n: "Idus", d: "수공예 마켓" },
            { n: "Hogangnono", d: "아파트 실거래 (직방)" },
            { n: "Modusign", d: "전자계약" },
            { n: "Miso", d: "홈서비스" },
            { n: "Seoltab", d: "실시간 수학 질문" },
            { n: "3.3", d: "세금 환급" },
            { n: "RAEL", d: "D2C 이커머스" },
            { n: "Laftel", d: "애니·만화 (리디)" },
            { n: "Upstage", d: "Enterprise AI" },
          ].map((p, i) => (
            <article
              key={i}
              className="group rounded-2xl border border-white/10 bg-white/5 p-4 hover:bg-white/10 transition"
            >
              <div className="aspect-[16/9] rounded-xl bg-zinc-900/60 border border-white/10 mb-3 flex items-center justify-center text-sm text-zinc-400">
                로고 영역
              </div>
